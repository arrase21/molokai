...
function M.setup(opts)
    ...
    for k, _ in pairs(opts) do
        if defaults[k] == nil then print("molokai: unknown setting: ", k) end
    end
    ...
    Color.new('red', '#ff1732')
    Color.new('magenta', '#d33682')
    Color.new('violet', '#6c71c4')
    Color.new('blue', '#30b1ff')
    Color.new('cyan', '#2aa198')
    Color.new('green', '#07f523')
    Color.new('purple', '#d497ee')
    ...
    Group.new('String', colors.yellow, colors.none, styles.italic)
